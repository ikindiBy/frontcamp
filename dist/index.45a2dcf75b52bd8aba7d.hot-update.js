...
var createCategoriesNav = function createCategoriesNav() {
  ...
  _constants__WEBPACK_IMPORTED_MODULE_0__["ALL_CATEGORIES"].forEach(function (cat) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            url = "https://newsapi.org/v2/sources?category=".concat(categoryId, "&apiKey=").concat(_constants__WEBPACK_IMPORTED_MODULE_0__["KEY"]);
            _context.next = 4;
            return Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["fetchByURL"])(url);

          case 4:
            response = _context.sent;
            div = Object(_viewCreators__WEBPACK_IMPORTED_MODULE_1__["createListSources"])(response.sources);
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            url = "https://newsapi.org/v2/top-headlines?sources=".concat(sourceId, "&apiKey=").concat(_constants__WEBPACK_IMPORTED_MODULE_0__["KEY"]);
            _context2.next = 4;
            return Object(_helpers__WEBPACK_IMPORTED_MODULE_2__["fetchByURL"])(url);

          case 4:
            response = _context2.sent;
            ul = Object(_viewCreators__WEBPACK_IMPORTED_MODULE_1__["createListArticles"])(response.articles);
            newsGroup.innerHTML = '';
...
//# sourceMappingURL=index.45a2dcf75b52bd8aba7d.hot-update.js.map